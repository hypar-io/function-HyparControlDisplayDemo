...
namespace HyparControlDisplayDemo
{
    public class Function
    {
        ...
        private IModelStore<HyparControlDisplayDemoInputs> store;

        public async Task<HyparControlDisplayDemoOutputs> Handler(HyparControlDisplayDemoInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<HyparControlDisplayDemoInputs>(RegionEndpoint.GetBySystemName("us-west-1"));
            }

            var l = new InvocationWrapper<HyparControlDisplayDemoInputs,HyparControlDisplayDemoOutputs>(store, HyparControlDisplayDemo.Execute);
