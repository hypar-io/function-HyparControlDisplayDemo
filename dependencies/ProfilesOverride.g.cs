...
{
	/// <summary>
	/// Override metadata for ProfilesOverride
	/// </summary>
	public partial class ProfilesOverride : IOverride
	{
	...
	public static class ProfilesOverrideExtensions
    {
		/// <summary>
        /// Apply Profiles edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Profiles Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<ProfilesOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, ProfilesIdentity, bool> identityMatch,
            Func<T, ProfilesOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Profiles Overrides to apply — typically `input.Overrides.Profiles`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<ProfilesOverride> overrideData,
            Func<T, ProfilesIdentity, bool> identityMatch,
            Func<T, ProfilesOverride, T> modifyElement
            ) where T : Element
        {
        ...
        /// </summary>
        /// <param name="edits">The collection of edit overrides (Overrides.Profiles)</param>
        /// <param name="additions">The collection of add overrides (Overrides.Additions.Profiles)</param>
        /// <param name="removals">The collection of remove overrides (Overrides.Removals.Profiles)</param>        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        ...
        public static List<T> CreateElements<T>(
            this IList<ProfilesOverride> edits,
            IList<ProfilesOverrideAddition> additions,
            IList<ProfilesOverrideRemoval> removals,            Func<ProfilesOverrideAddition, T> createElement,
            Func<T, ProfilesIdentity, bool> identityMatch,
            Func<T, ProfilesOverride, T> modifyElement,
